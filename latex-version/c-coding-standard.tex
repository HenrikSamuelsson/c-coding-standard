...
identifier & A name given to an entity such as variables, functions, structures etc. \\
...
type & Variable classification such as; int, char, and double, that determines storage size and how the bit pattern stored shall be interpreted.\\
...
All allowed strategies minimizes the risk that a pair of members is assigned the same value by mistake. 
